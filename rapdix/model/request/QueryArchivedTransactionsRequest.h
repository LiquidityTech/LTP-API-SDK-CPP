...
class QueryArchivedTransactionsRequest {
public:
    class Builder {
    public:
        ...
        QueryArchivedTransactionsRequest build() {
            return QueryArchivedTransactionsRequest(*this);
        }
        
    private:
        friend class QueryArchivedTransactionsRequest;
        std::string orderId_;
        std::string sym_;
        std::string begin_;
        std::string end_;
...
private:
    QueryArchivedTransactionsRequest(const Builder& builder) :
