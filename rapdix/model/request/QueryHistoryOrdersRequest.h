...
class QueryHistoryOrdersRequest {
public:
    class Builder {
    public:
        ...
        QueryHistoryOrdersRequest build() {
            return QueryHistoryOrdersRequest(*this);
        }
        
    private:
        friend class QueryHistoryOrdersRequest;
        std::string sym_;
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(QueryHistoryOrdersRequest,
        sym,
        businessType,
        exchange,
        begin,
...
private:
    QueryHistoryOrdersRequest(const Builder& builder) :
        sym(builder.sym_),
